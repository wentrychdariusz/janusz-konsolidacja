  ...
  return (
    <section className="bg-gradient-to-b from-black via-navy-900 to-business-blue-800 relative py-16 md:py-24 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Photo mosaic grid - seamless with no gaps and increased height */}
        <div className="absolute inset-0 grid grid-cols-8 md:grid-cols-12 lg:grid-cols-16 opacity-50">
          {/* Row 1 */}
          <img src="/lovable-uploads/625db739-f793-41f1-bf7a-c329c72cf5d6.png" alt="" className="w-full h-20 md:h-24 lg:h-28 object-cover" />
          <img src="/lovable-uploads/8bbcb19e-bb1a-4285-b18a-121c8bf0c5bc.png" alt="" className="w-full h-20 md:h-24 lg:h-28 object-cover" />
          ...
          <img src="/lovable-uploads/ce712082-8c47-4d6f-bb24-515aa5736ef7.png" alt="" className="w-full h-20 md:h-24 lg:h-28 object-cover" />
